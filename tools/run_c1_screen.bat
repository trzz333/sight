...
echo START %DATE% %TIME% seed %SEED% > "%OUT%\run.log"
"%PY%" -u tools\c1_es_train.py --seed %SEED% --vec subproc --n-workers 8 --seeds-per-gen 4 --gens 100 --sigma0 0.1 --out "%OUT%" >> "%OUT%\run.log" 2>&1
