...
**Last commit:** `0e96bfe` chore: refresh handoff hash (on top of `0567fec` fix(rl): isolate godot tcp port and absolute godot log path for h4 live train). This round's packet-landing commit appends.
